...
TEST_UNIT "multiply_matricies_test1" = assert_true (multiply_matricies [[4]] [[2]] = [[8]])
TEST_UNIT "multiply_matricies_test2" = assert_true (multiply_matricies [[1;2]] [[3];[4]] = [[11]])
...
TEST_UNIT "first_answer_test3" = assert_true (first_answer tester5 [1;2;3;4] = 2)
